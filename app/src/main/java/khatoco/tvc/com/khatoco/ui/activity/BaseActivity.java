...
import khatoco.tvc.com.khatoco.ui.dialogs.SimpleAlertDialog;
...
public class BaseActivity extends AppCompatActivity implements Observer, View.OnClickListener, ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected AlertDialog dialogAlertPermission;
...
//    }
//
    protected AlertDialog showErrorMessage(int string, int tittle, int cancel, int accept, Runnable onCancel, Runnable onAccept) {
        alertDialog = SimpleAlertDialog.showMessageWithCancelAndAcceptButtons(this, getString(tittle), getString(string), getString(cancel).toUpperCase(), getString(accept).toUpperCase(), onCancel, onAccept).create();
        return alertDialog;
    }
...
//    }
    ...
    protected AlertDialog showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        if (dialogAlertPermission == null) {
            dialogAlertPermission = new AlertDialog.Builder(this)
                    .setMessage(message)
                    .setPositiveButton("OK", okListener)
                    .create();
        }
        return dialogAlertPermission;
    ...
    public void onResume() {
        ...
        KhatocoApplication.getInstance().setConnectivityListener(this);
    }
